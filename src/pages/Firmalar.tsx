...
const Firmalar = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Peyzaj Firmaları | Türkiye Peyzaj Rehberi</title>
        <meta name="description" content="Türkiye genelindeki peyzaj firmalarını keşfedin. Bahçe tasarımı, peyzaj mimarlığı ve daha fazlası için güvenilir firmalar." />
      </Helmet>
      <Navbar />
