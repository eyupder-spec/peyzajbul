...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Peyzaj Blog | Bahçe Bakımı ve Peyzaj Rehberi</title>
        <meta name="description" content="Peyzaj tasarım, bahçe bakımı, bitki seçimi ve dış mekan düzenleme hakkında uzman tavsiyeleri ve güncel trendler." />
      </Helmet>
      <Navbar />
